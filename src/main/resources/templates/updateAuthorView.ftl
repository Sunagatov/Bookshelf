...
<div class="main">
    <form action="/updateAuthor/${author.id}" method="post">
        <div class="registration">
            ...
            <input type="text" id="image_link" name="image_link" value="${author.imageLink}">
            <label for="fname">Full Name:</label>
            <input type="text" id="fname" name="full_name" value="${author.fullName}">
            <label for="nickname">Nickname:</label>
            <input type="text" id="nickname" name="nickname" value="${author.nickName}">
