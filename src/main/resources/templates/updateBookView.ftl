...
<div class="main">
    <form action="/updateBook/${book.id}" method="post">
        <div class="registration">
            ...
            <input type="text" id="image_link" name="image_link" value="${book.imageLink}">
            ...
            <select multiple name="authors">
                ...
                <#list bookAuthors as bookAuthor>
                    <option selected="selected" value="${bookAuthor.id}">${bookAuthor.nickName}</option>
                </#list>
            ...
            <input type="text" id="page_count" name="pageCount" value="${book.pageCount}">
            <label for="pdf_link">pdf link:</label>
            <input type="text" id="pdf_link" name="pdf_link" value="${book.pdfLink}">
            <label for="epubLink">epub link:</label>
            <input type="text" id="epubLink" name="epubLink" value="${book.epubLink}">
            <label for="fb2Link">fb2 link:</label>
            <input type="text" id="fb2Link" name="fb2Link" value="${book.fb2Link}">
            <label>Publication date:</label>
            <div class="publicationDate">
                <div class="publicationDate_Day">
                    <select name="publicationDay">
                        <option value="-1">Day:</option>
                        <option selected="selected" value="${book.publicationDate.dayOfMonth}">
                            ${book.publicationDate.dayOfMonth}
                        </option>
                ...
                <div class="publicationDate_Month">
                    <select name="publicationMonth">
                        ...
                        <option selected="selected" value="${book.publicationDate.monthValue}">
                            ${book.publicationDate.monthValue} month of year
                        </option>
